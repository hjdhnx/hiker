const ali = {
    ...
    rendererSuggest: function(d, atSearchPage) {
        try {
            const {data} = JSON.parse(fetch('https://api.web.360kan.com/v1/query/addef?ver=2&fmt=json',{headers:{
    ...
    homeData: function(d) {
        ...
        res=this.linkProcessing(res,url);
            ...
            tid.forEach((value, index) => {
                ...
                if (!!_link) {
                    ...
                    if(share_id) {
                        ...
                        playLink = 'http://59.47.74.33:3000/apis/yun-play/'+share_id+'/'+file_id+'/'+access_token+'/'+share_token+'/'+value+'/'+drive_id+'/'+user_id+'/'+device_id+'/index.m3u8';
                    } else if(drive_id) {
